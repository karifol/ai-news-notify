...
| [Google Gemini](https://blog.google/products/gemini/) | RSS (`/products/gemini/rss/`) → HTML フォールバック |
| [Claude Code](https://github.com/anthropics/claude-code/releases) | GitHub Atom フィード (`/releases.atom`) |
